...

{
    ...
    description:
      "Interactive Power BI dashboard analyzing retail sales performance, profitability, regional trends, customer segments, and business growth with actionable recommendations for improving operational efficiency and profit margins.",

    image: "assets/projects/retail-sales-img/first.png",
    screenshots: [
    ...
    youtube:
      "https://www.youtube.com/embed/ZP4NctNYBtk?autoplay=1&mute=1",

    github:
      "https://github.com/Yogesh8979/Retail-sales-analysis-report",
    ...
    businessProblem: [
      "The company generates strong revenue but struggles to understand why profit margins remain low despite consistent sales growth.",
      "Identify the key factors affecting profitability across regions, customer segments, and product categories.",
      "Analyze sales trends, operational efficiency, and low-performing products using interactive business intelligence dashboards.",
      "Provide actionable recommendations to improve profit margins, optimize pricing strategies, and support data-driven business decisions."
    ],

    features: [
      "Retail Sales Performance Dashboard",
      "Trend & Growth Analysis",
      "Business Drivers & Profit Segmentation",
      "Business Recommendations & Action Plan"
    ],

    challenges: [
      "Cleaning and transforming retail sales data from MySQL",
      "Building complex DAX measures and interactive business dashboards"
    ],
...

{
  ...
  //   youtube:
  //   "https://www.youtube.com/embed/lMqoFXkNb8w?autoplay=1&mute=1",
  ...
  //   youtube:
  //     // 
  //     "https://www.youtube.com/embed/ZP4NctNYBtk?autoplay=1",
  ...
  //   youtube:
  //     "https://www.youtube.com/embed/qv0U8Tpmui0?autoplay=1",
